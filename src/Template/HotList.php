                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    ...
                    <div class="shop-pro-content">
                        ...
                        <div class="ec-pro-pagination">
                            ...
                            <?php if($page > 1): ?>
                                <li><a class="next" href="<?=excUrl('Index/HotList')?>?page=<?=$page-1?>"> <i class="ecicon eci-angle-left"></i></a></li>
                            <?php endif; ?>
                            <?php if(count($hot) == 12): ?>
                                <li><a class="next" href="<?=excUrl('Index/HotList')?>?page=<?=$page+1?>"> <i class="ecicon eci-angle-right"></i></a></li>
                            <?php endif; ?>
                            </ul>
                        </div>
                        <!-- Ec Pagination End -->
